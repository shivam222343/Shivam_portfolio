    ...
    <>
      <div className="navbar h-24 w-screen bg-gradient-to-tl from-black to-blue-950 flex justify-between items-center p-[1vw] ">
        <div className='h-24 w-auto flex justify-center items-center'>
          ...
          <div className="text h-16 w-auto flex flex-col ml-3 justify-center text-xl pr-4 text-white font-semibold ">
            <span>Shivam</span>
            <span>Dombe</span>
          </div>
        </div>
        <div className="text hidden xl:block md:items-center h-16 min-w-96 ml-3 md:justify-center text-xl text-white font-semibold ">
          <ul className='flex h-16 flex-row gap-[3vw] justify-center items-center'>
           <NavLink to="/Education"> <div className="Education cursor-pointer">Education</div></NavLink>
           <NavLink to="/Projects"> <div className="Projects cursor-pointer">Projects</div></NavLink>
           <NavLink to="/Skills"><div className="Skills cursor-pointer">skills</div></NavLink>
           <NavLink to="/Work-Experiance"> <div className="Work-Experience cursor-pointer">Work Experience</div></NavLink>
           <NavLink to="/Certificate">   <div className="Certificate cursor-pointer">Certificate</div></NavLink>
          </ul>
        </div>
        ...
        <NavLink to="/Options" className="menu md:hidden text-white flex justify-center items-center cursor-pointer text-5xl"> <RiMenu3Line /></NavLink>
        </div>
      </div>
    </>
  )
