...
const Pop = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gradient-to-tl from-black to-blue-950">
      ...
      {showPopup && (
        <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50 mt-10">
          <div className="bg-slate-800 rounded-lg shadow-lg w-11/12 max-w-lg p-6 space-y-4">
           ...
           <h2 className="text-xl font-semibold text-red-700 text-center">Details</h2>
            ...
            <NavLink to="/"><div className='Home text-2xl text-white'><TbHomeHand/></div></NavLink>
            <button
            ...
            <div className="space-y-3 text-white">
              ...
              <NavLink to="/Details">  <button className='h-10 w-auto px-3 cursor-pointer rounded-md text-slate-900 font-semibold bg-green-400'>Veiw</button></NavLink>
              </div>

              <div className="bg-slate-900 p-3 rounded-md flex justify-between">
                <h3 className="text-md font-semibold">Projects</h3>
                <NavLink to="/Projects">  <button className='h-10 w-auto px-3 cursor-pointer rounded-md text-slate-900 font-semibold bg-green-400'>Veiw</button></NavLink>
              </div>
